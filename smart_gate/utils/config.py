...
def load_config() -> AppConfig:
    ...
    endpoints = {
        ...
        "AUTH_DESKTOP_START": get("AUTH_DESKTOP_START_ENDPOINT", DEFAULT_ENDPOINTS["AUTH_DESKTOP_START"]),
        "AUTH_DESKTOP_EXCHANGE": get("AUTH_DESKTOP_EXCHANGE_ENDPOINT", DEFAULT_ENDPOINTS["AUTH_DESKTOP_EXCHANGE"]),
        "AUTH_REFRESH": get("AUTH_REFRESH_ENDPOINT", DEFAULT_ENDPOINTS["AUTH_REFRESH"]),
        "DEVICES_REGISTER": get("DEVICES_REGISTER_ENDPOINT", DEFAULT_ENDPOINTS["DEVICES_REGISTER"]),
        "DEVICES_CHECK": get("DEVICES_CHECK_ENDPOINT", DEFAULT_ENDPOINTS["DEVICES_CHECK"]),
        ...
        "EVENTS_BATCH": get("EVENTS_BATCH_ENDPOINT", DEFAULT_ENDPOINTS["EVENTS_BATCH"]),
